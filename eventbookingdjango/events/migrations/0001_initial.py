# Generated by Django 5.1.6 on 2025-04-28 14:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sold_tickets', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_code', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='payments', to='events.discountcode')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payments', to=settings.AUTH_USER_MODEL)),
                ('tickets', models.ManyToManyField(blank=True, related_name='payments', to='events.ticket')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('notification', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_notifications', to='events.notification')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='trending_log', to='events.event')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='payment',
            index=models.Index(fields=['user', 'status'], name='events_paym_user_id_955cb0_idx'),
        ),
        migrations.AddIndex(
            model_name='payment',
            index=models.Index(fields=['transaction_id'], name='events_paym_transac_393dd3_idx'),
        ),
